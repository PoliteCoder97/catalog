          ...
          public void onCompleted(Exception e, String result) {
            ...
            try {
              ...
              if (jsonObject.getBoolean("error")) {
                Toast.makeText(PanelProductsListActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                return;
              }

              categoryList.remove(event.getProduct());
              App.database.getProductDao().delete(event.getProduct());
              panelProductListAdapter.notifyDataSetChanged();
