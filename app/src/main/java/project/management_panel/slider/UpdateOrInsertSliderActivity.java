...
public class UpdateOrInsertSliderActivity extends AppCompatActivity {
    //widgets
...
//        txtTitle.setText("Update Person");
        ...
        if (bundle != null) {
            slideId = bundle.getInt("id");
            image = bundle.getString("image");
//            edtName.setText(" " + bundle.getString("name"));
//            edtDesc.setText(" " + bundle.getString("desc"));

            GlideApp.with(this)
                    .load(Utils.checkVersionAndBuildUrl(Consts.GET_SLIDER_IMAGE + bundle.getString("image")))
...
//            edtDesc.setText("");
    ...
    void btnSubmitClicked(View v) {
        ...
        params.put("slideId", Collections.singletonList(String.valueOf(slideId)));


        if (realPath_1.equals("") || realPath_1 == null) {
            app_loading.setVisibility(View.GONE);
            wating = false;
            Toast.makeText(this, "you most select one file", Toast.LENGTH_SHORT).show();
            return;
        }

        Ion.with(this)
                .load(Utils.checkVersionAndBuildUrl("CatalogApp_Api/v1/panel/insert_update_slide.php"))
...
//                        sendCompleted(e, strResult, message);
                        ...
                        if (e != null) {
                            Log.i("UPDATE_Slide", "error: " + e.toString());
                            return;
                        }

                        Log.i("UPDATE_Slide", "result: " + strResult);
                        try {
                            JSONObject jsonObject = new JSONObject(strResult);
                            if (jsonObject.getBoolean("error")) {
                                Toast.makeText(UpdateOrInsertSliderActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                                return;
                            }
                            Toast.makeText(UpdateOrInsertSliderActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
    ...
    void rLayImgClicked(View v) {
        if (ContextCompat.checkSelfPermission(UpdateOrInsertSliderActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
    ...
    private void writeExternalStoragePersmission() {
        ...
        permissionHelper.request(new PermissionHelper.PermissionCallback() {
            ...
            public void onPermissionDenied() {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(UpdateOrInsertSliderActivity.this);
                @SuppressLint("InflateParams")
                View permissioDialog = LayoutInflater.from(UpdateOrInsertSliderActivity.this).inflate(R.layout.dialog_permission, null, false);
